...
import { getDocumentosRechazados, mostrarDocumentosRechazados} from '../../actions/documentosRechazados-action';
...
class DocumentosRechazados extends Component {
    ...
    async componentDidMount(){
        ...
        await this.props.getDocumentosRechazados( usuario.db, usuario.access_token );

        await this.props.mostrarDocumentosRechazados();
    ...
    descargarReporte(){
        ...
        if (dateIn == '' || dateOut == '') {
            ...
            const documentos = [...this.props.documentosRechazados];
    ...
    render() {
        ...
        this.props.documentosRechazados.map( documento => {
                        ...
                        <Card>
                            ...
                            <CardBody>
                                <BootstrapTable data={dataRow} striped hover  pagination >
                                    ...
                                    <TableHeaderColumn dataField='Empresa'              width='300px' filter={ { type: 'RegexFilter', placeholder: 'Buscar...' } } >Empresa</TableHeaderColumn>
...
const mapStateToProps = state => {
    ...
    return {
        ...
        documentosRechazados: state.documentosRechazados.documentosRechazados
    };
};

//export default CargaDocumentos;
export default connect(mapStateToProps, {obtenerUsuario, getDocumentosRechazados, mostrarDocumentosRechazados})(DocumentosRechazados);
